...
#define GO_GPU        (1ull << 22) // SDL_GPU renderer (DEFAULT ON, opt-out; falls back to SDL_Renderer)
#define GO_SHADERFX   (1ull << 23) // Batched sprite effects (DEFAULT ON; needs GO_GPU, falls back to CPU bake)

...
unsigned char fonta_035[] =
    /* # */ {254, 1, 2, 254, 0, 1, 1, 1, 1, 254, 1, 2, 254, 1, 2, 254, 0, 1, 1, 1, 1, 254, 1, 2, 255};
unsigned char fonta_036[] =
    /* $ */ {1, 1, 1, 254, 0, 2, 2, 254, 0, 2, 254, 1, 1, 1, 254, 2, 2, 254, 2, 2, 254, 0, 2, 2, 254, 1, 1, 1, 255};
unsigned char fonta_037[] = /* % */ {254, 0, 1, 3, 254, 0, 3, 254, 3, 254, 2, 254, 1, 254, 1, 3, 254, 0, 3, 1, 255};
unsigned char fonta_038[] =
    /* & */ {1, 1, 254, 0, 3, 254, 0, 2, 254, 1, 254, 1, 254, 0, 2, 2, 254, 0, 3, 254, 1, 1, 2, 255};
...
unsigned char fonta_048[] =
    /* 0 */ {1, 1, 254, 0, 2, 1, 254, 0, 3, 254, 0, 3, 254, 0, 3, 254, 0, 3, 254, 0, 1, 2, 254, 1, 1, 255};
...
unsigned char fonta_052[] =
    /* 4 */ {2, 1, 254, 1, 2, 254, 1, 2, 254, 0, 3, 254, 0, 1, 1, 1, 254, 3, 254, 3, 254, 3, 255};
unsigned char fonta_053[] = /* 5 */ {0, 1, 1, 1, 254, 0, 254, 0, 254, 1, 254, 2, 254, 3, 254, 0, 3, 254, 1, 1, 255};
unsigned char fonta_054[] =
    /* 6 */ {1, 1, 254, 0, 254, 0, 254, 0, 1, 1, 254, 0, 3, 254, 0, 3, 254, 0, 3, 254, 1, 1, 255};
unsigned char fonta_055[] = /* 7 */ {0, 1, 1, 1, 254, 3, 254, 3, 254, 2, 254, 2, 254, 1, 254, 1, 254, 0, 255};
unsigned char fonta_056[] =
    /* 8 */ {1, 1, 254, 0, 3, 254, 0, 3, 254, 1, 1, 254, 0, 3, 254, 0, 3, 254, 0, 3, 254, 1, 1, 255};
unsigned char fonta_057[] =
    /* 9 */ {1, 1, 254, 0, 3, 254, 0, 3, 254, 1, 1, 1, 254, 3, 254, 3, 254, 0, 3, 254, 1, 1, 255};
...
unsigned char fonta_064[] = /* @ */ {
    2, 1, 1, 254, 1, 4, 254, 0, 3, 1, 2, 254, 0, 2, 2, 2, 254, 0, 2, 2, 2, 254, 0, 3, 2, 254, 1, 254, 2, 1, 1, 255};
unsigned char fonta_065[] =
    /* A */ {2, 254, 2, 254, 1, 2, 254, 1, 2, 254, 1, 1, 1, 254, 0, 4, 254, 0, 4, 254, 0, 4, 255};
unsigned char fonta_066[] =
    /* B */ {0, 1, 1, 254, 0, 3, 254, 0, 3, 254, 0, 1, 1, 254, 0, 3, 254, 0, 3, 254, 0, 3, 254, 0, 1, 1, 255};
unsigned char fonta_067[] = /* C */ {1, 1, 254, 0, 3, 254, 0, 254, 0, 254, 0, 254, 0, 254, 0, 3, 254, 1, 1, 255};
unsigned char fonta_068[] =
    /* D */ {0, 1, 1, 254, 0, 3, 254, 0, 3, 254, 0, 3, 254, 0, 3, 254, 0, 3, 254, 0, 3, 254, 0, 1, 1, 255};
unsigned char fonta_069[] =
    /* E */ {0, 1, 1, 1, 254, 0, 254, 0, 254, 0, 1, 1, 254, 0, 254, 0, 254, 0, 254, 0, 1, 1, 1, 255};
unsigned char fonta_070[] = /* F */ {0, 1, 1, 1, 254, 0, 254, 0, 254, 0, 1, 1, 254, 0, 254, 0, 254, 0, 254, 0, 255};
unsigned char fonta_071[] =
    /* G */ {1, 1, 254, 0, 3, 254, 0, 254, 0, 254, 0, 2, 1, 254, 0, 3, 254, 0, 3, 254, 1, 1, 255};
unsigned char fonta_072[] =
    /* H */ {0, 3, 254, 0, 3, 254, 0, 3, 254, 0, 3, 254, 0, 1, 1, 1, 254, 0, 3, 254, 0, 3, 254, 0, 3, 255};
...
unsigned char fonta_075[] =
    /* K */ {0, 4, 254, 0, 3, 254, 0, 3, 254, 0, 2, 254, 0, 1, 254, 0, 2, 254, 0, 3, 254, 0, 4, 255};
unsigned char fonta_076[] = /* L */ {0, 254, 0, 254, 0, 254, 0, 254, 0, 254, 0, 254, 0, 254, 0, 1, 1, 1, 255};
unsigned char fonta_077[] = /* M */ {
    0, 4, 254, 0, 1, 2, 1, 254, 0, 1, 2, 1, 254, 0, 2, 2, 254, 0, 2, 2, 254, 0, 2, 2, 254, 0, 4, 254, 0, 4, 255};
unsigned char fonta_078[] =
    /* N */ {0, 3, 254, 0, 3, 254, 0, 1, 2, 254, 0, 1, 2, 254, 0, 2, 1, 254, 0, 2, 1, 254, 0, 2, 1, 254, 0, 3, 255};
unsigned char fonta_079[] =
    /* O */ {1, 1, 254, 0, 3, 254, 0, 3, 254, 0, 3, 254, 0, 3, 254, 0, 3, 254, 0, 3, 254, 1, 1, 255};
unsigned char fonta_080[] =
    /* P */ {0, 1, 1, 254, 0, 3, 254, 0, 3, 254, 0, 3, 254, 0, 1, 1, 254, 0, 254, 0, 254, 0, 255};
unsigned char fonta_081[] =
    /* Q */ {1, 1, 254, 0, 3, 254, 0, 3, 254, 0, 3, 254, 0, 3, 254, 0, 3, 254, 0, 2, 1, 254, 1, 1, 1, 255};
unsigned char fonta_082[] =
    /* R */ {0, 1, 1, 254, 0, 3, 254, 0, 3, 254, 0, 3, 254, 0, 1, 1, 254, 0, 1, 254, 0, 2, 254, 0, 2, 1, 255};
...
unsigned char fonta_085[] =
    /* U */ {0, 3, 254, 0, 3, 254, 0, 3, 254, 0, 3, 254, 0, 3, 254, 0, 3, 254, 0, 3, 254, 1, 1, 255};
unsigned char fonta_086[] =
    /* V */ {0, 4, 254, 0, 4, 254, 0, 4, 254, 0, 4, 254, 1, 2, 254, 1, 2, 254, 1, 2, 254, 2, 255};
unsigned char fonta_087[] =
    /* W */ {0, 4, 254, 0, 4, 254, 0, 4, 254, 0, 4, 254, 0, 2, 2, 254, 0, 2, 2, 254, 0, 1, 2, 1, 254, 1, 2, 255};
unsigned char fonta_088[] =
    /* X */ {0, 4, 254, 0, 4, 254, 1, 2, 254, 1, 2, 254, 2, 254, 1, 2, 254, 0, 4, 254, 0, 4, 255};
unsigned char fonta_089[] =
    /* Y */ {0, 4, 254, 0, 4, 254, 0, 4, 254, 1, 2, 254, 1, 2, 254, 2, 254, 2, 254, 1, 1, 1, 255};
...
unsigned char fonta_098[] =
    /* b */ {0, 254, 0, 254, 0, 254, 0, 1, 1, 254, 0, 3, 254, 0, 3, 254, 0, 3, 254, 0, 1, 1, 255};
unsigned char fonta_099[] = /* c */ {254, 254, 254, 1, 1, 254, 0, 3, 254, 0, 254, 0, 3, 254, 1, 1, 255};
unsigned char fonta_100[] =
    /* d */ {3, 254, 3, 254, 3, 254, 1, 1, 1, 254, 0, 3, 254, 0, 3, 254, 0, 3, 254, 1, 1, 1, 255};
...
unsigned char fonta_109[] =
    /* m */ {254, 254, 254, 0, 1, 2, 254, 0, 2, 2, 254, 0, 2, 2, 254, 0, 2, 2, 254, 0, 2, 2, 255};
...
unsigned char fonta_121[] =
    /* y */ {254, 254, 254, 0, 3, 254, 0, 3, 254, 0, 3, 254, 1, 1, 1, 254, 3, 254, 0, 1, 1, 255};
...
unsigned char fontc_035[] = /* # */ {1, 3, 254, 1, 3, 254, 0, 1, 1, 1, 1, 1, 254, 1, 3, 254, 1, 3, 254, 1, 3, 254, 0, 1,
    1, 1, 1, 1, 254, 1, 3, 254, 1, 3, 255};
unsigned char fontc_036[] = /* $ */ {
    2, 254, 1, 1, 1, 254, 0, 2, 2, 254, 0, 2, 254, 1, 1, 254, 2, 1, 254, 2, 2, 254, 0, 2, 2, 254, 1, 1, 1, 254, 2, 255};
unsigned char fontc_037[] =
    /* % */ {1, 1, 254, 0, 3, 3, 254, 1, 1, 3, 254, 4, 254, 3, 254, 2, 254, 1, 3, 1, 254, 0, 3, 3, 254, 4, 1, 255};
unsigned char fontc_038[] =
    /* & */ {1, 254, 0, 2, 254, 0, 2, 254, 1, 254, 1, 254, 0, 2, 2, 254, 0, 3, 254, 0, 3, 254, 1, 1, 2, 255};
unsigned char fontc_039[] = /* ' */ {0, 2, 254, 0, 2, 254, 0, 2, 255};
unsigned char fontc_040[] =
    /* ( */ {1, 254, 0, 254, 0, 254, 0, 254, 0, 254, 0, 254, 0, 254, 0, 254, 0, 254, 0, 254, 1, 255};
unsigned char fontc_041[] =
    /* ) */ {0, 254, 1, 254, 1, 254, 1, 254, 1, 254, 1, 254, 1, 254, 1, 254, 1, 254, 1, 254, 0, 255};
...
unsigned char fontc_048[] =
    /* 0 */ {1, 1, 1, 254, 0, 4, 254, 0, 4, 254, 0, 4, 254, 0, 4, 254, 0, 4, 254, 0, 4, 254, 0, 4, 254, 1, 1, 1, 255};
unsigned char fontc_049[] = /* 1 */ {2, 254, 1, 1, 254, 2, 254, 2, 254, 2, 254, 2, 254, 2, 254, 2, 254, 2, 255};
unsigned char fontc_050[] =
    /* 2 */ {1, 1, 1, 254, 0, 4, 254, 4, 254, 4, 254, 3, 254, 2, 254, 1, 254, 0, 254, 0, 1, 1, 1, 1, 255};
unsigned char fontc_051[] =
    /* 3 */ {1, 1, 1, 254, 0, 4, 254, 4, 254, 4, 254, 2, 1, 254, 4, 254, 4, 254, 0, 4, 254, 1, 1, 1, 255};
unsigned char fontc_052[] =
    /* 4 */ {3, 254, 2, 1, 254, 2, 1, 254, 1, 2, 254, 1, 2, 254, 0, 3, 254, 0, 1, 1, 1, 1, 254, 3, 254, 3, 255};
unsigned char fontc_053[] =
    /* 5 */ {0, 1, 1, 1, 1, 254, 0, 254, 0, 254, 0, 1, 1, 1, 254, 0, 4, 254, 4, 254, 4, 254, 0, 4, 254, 1, 1, 1, 255};
unsigned char fontc_054[] =
    /* 6 */ {1, 1, 1, 254, 0, 4, 254, 0, 254, 0, 254, 0, 1, 1, 1, 254, 0, 4, 254, 0, 4, 254, 0, 4, 254, 1, 1, 1, 255};
unsigned char fontc_055[] =
    /* 7 */ {0, 1, 1, 1, 1, 254, 4, 254, 3, 254, 3, 254, 2, 254, 2, 254, 1, 254, 1, 254, 1, 255};
unsigned char fontc_056[] = /* 8 */ {
    1, 1, 1, 254, 0, 4, 254, 0, 4, 254, 0, 4, 254, 1, 1, 1, 254, 0, 4, 254, 0, 4, 254, 0, 4, 254, 1, 1, 1, 255};
unsigned char fontc_057[] =
    /* 9 */ {1, 1, 1, 254, 0, 4, 254, 0, 4, 254, 0, 4, 254, 1, 1, 1, 1, 254, 4, 254, 4, 254, 0, 4, 254, 1, 1, 1, 255};
...
unsigned char fontc_064[] = /* @ */ {3, 1, 1, 1, 254, 1, 1, 5, 1, 254, 1, 7, 254, 0, 4, 1, 1, 3, 254, 0, 3, 3, 3, 254,
    0, 3, 3, 3, 254, 0, 4, 1, 2, 1, 1, 254, 1, 254, 1, 1, 254, 3, 1, 1, 1, 1, 255};
unsigned char fontc_065[] =
    /* A */ {3, 254, 3, 254, 2, 2, 254, 2, 2, 254, 1, 4, 254, 1, 4, 254, 1, 1, 1, 1, 1, 254, 0, 6, 254, 0, 6, 255};
unsigned char fontc_066[] = /* B */ {0, 1, 1, 1, 254, 0, 4, 254, 0, 4, 254, 0, 4, 254, 0, 1, 1, 1, 254, 0, 4, 254, 0, 4,
    254, 0, 4, 254, 0, 1, 1, 1, 255};
unsigned char fontc_067[] =
    /* C */ {1, 1, 1, 1, 254, 0, 5, 254, 0, 254, 0, 254, 0, 254, 0, 254, 0, 254, 0, 5, 254, 1, 1, 1, 1, 255};
unsigned char fontc_068[] = /* D */ {
    0, 1, 1, 1, 254, 0, 4, 254, 0, 5, 254, 0, 5, 254, 0, 5, 254, 0, 5, 254, 0, 5, 254, 0, 4, 254, 0, 1, 1, 1, 255};
unsigned char fontc_069[] =
    /* E */ {0, 1, 1, 1, 1, 254, 0, 254, 0, 254, 0, 254, 0, 1, 1, 1, 254, 0, 254, 0, 254, 0, 254, 0, 1, 1, 1, 1, 255};
unsigned char fontc_070[] =
    /* F */ {0, 1, 1, 1, 1, 254, 0, 254, 0, 254, 0, 254, 0, 1, 1, 1, 254, 0, 254, 0, 254, 0, 254, 0, 255};
unsigned char fontc_071[] = /* G */ {
    1, 1, 1, 1, 254, 0, 5, 254, 0, 254, 0, 254, 0, 3, 1, 1, 254, 0, 5, 254, 0, 5, 254, 0, 4, 1, 254, 1, 1, 1, 2, 255};
unsigned char fontc_072[] = /* H */ {
    0, 5, 254, 0, 5, 254, 0, 5, 254, 0, 5, 254, 0, 1, 1, 1, 1, 1, 254, 0, 5, 254, 0, 5, 254, 0, 5, 254, 0, 5, 255};
...
unsigned char fontc_075[] =
    /* K */ {0, 4, 254, 0, 3, 254, 0, 2, 254, 0, 1, 254, 0, 1, 254, 0, 2, 254, 0, 3, 254, 0, 4, 254, 0, 5, 255};
unsigned char fontc_076[] =
    /* L */ {0, 254, 0, 254, 0, 254, 0, 254, 0, 254, 0, 254, 0, 254, 0, 254, 0, 1, 1, 1, 1, 255};
unsigned char fontc_077[] = /* M */ {0, 6, 254, 0, 6, 254, 0, 1, 4, 1, 254, 0, 1, 4, 1, 254, 0, 2, 2, 2, 254, 0, 2, 2,
    2, 254, 0, 3, 3, 254, 0, 3, 3, 254, 0, 6, 255};
unsigned char fontc_078[] = /* N */ {0, 5, 254, 0, 1, 4, 254, 0, 1, 4, 254, 0, 2, 3, 254, 0, 2, 3, 254, 0, 3, 2, 254, 0,
    4, 1, 254, 0, 4, 1, 254, 0, 5, 255};
unsigned char fontc_079[] = /* O */ {
    1, 1, 1, 1, 254, 0, 5, 254, 0, 5, 254, 0, 5, 254, 0, 5, 254, 0, 5, 254, 0, 5, 254, 0, 5, 254, 1, 1, 1, 1, 255};
unsigned char fontc_080[] =
    /* P */ {0, 1, 1, 1, 1, 254, 0, 5, 254, 0, 5, 254, 0, 5, 254, 0, 1, 1, 1, 1, 254, 0, 254, 0, 254, 0, 254, 0, 255};
unsigned char fontc_081[] = /* Q */ {1, 1, 1, 1, 254, 0, 5, 254, 0, 5, 254, 0, 5, 254, 0, 5, 254, 0, 5, 254, 0, 3, 2,
    254, 0, 4, 1, 254, 1, 1, 1, 1, 254, 5, 255};
unsigned char fontc_082[] = /* R */ {0, 1, 1, 1, 1, 254, 0, 5, 254, 0, 5, 254, 0, 5, 254, 0, 1, 1, 1, 1, 254, 0, 5, 254,
    0, 5, 254, 0, 5, 254, 0, 5, 255};
unsigned char fontc_083[] =
    /* S */ {1, 1, 1, 254, 0, 4, 254, 0, 254, 0, 254, 1, 1, 1, 254, 4, 254, 4, 254, 0, 4, 254, 1, 1, 1, 255};
unsigned char fontc_084[] =
    /* T */ {0, 1, 1, 1, 1, 254, 2, 254, 2, 254, 2, 254, 2, 254, 2, 254, 2, 254, 2, 254, 2, 255};
unsigned char fontc_085[] =
    /* U */ {0, 5, 254, 0, 5, 254, 0, 5, 254, 0, 5, 254, 0, 5, 254, 0, 5, 254, 0, 5, 254, 0, 5, 254, 1, 1, 1, 1, 255};
unsigned char fontc_086[] =
    /* V */ {0, 6, 254, 0, 6, 254, 1, 4, 254, 1, 4, 254, 1, 4, 254, 2, 2, 254, 2, 2, 254, 3, 254, 3, 255};
unsigned char fontc_087[] = /* W */ {0, 10, 254, 0, 10, 254, 1, 4, 4, 254, 1, 4, 4, 254, 1, 4, 4, 254, 2, 2, 2, 2, 254,
    2, 2, 2, 2, 254, 3, 4, 254, 3, 4, 255};
unsigned char fontc_088[] =
    /* X */ {0, 6, 254, 0, 6, 254, 1, 4, 254, 2, 2, 254, 3, 254, 2, 2, 254, 1, 4, 254, 0, 6, 254, 0, 6, 255};
unsigned char fontc_089[] =
    /* Y */ {0, 6, 254, 0, 6, 254, 1, 4, 254, 2, 2, 254, 3, 254, 3, 254, 3, 254, 3, 254, 3, 255};
unsigned char fontc_090[] = /* Z */ {
    0, 1, 1, 1, 1, 1, 1, 254, 6, 254, 5, 254, 4, 254, 3, 254, 2, 254, 1, 254, 0, 254, 0, 1, 1, 1, 1, 1, 1, 255};
unsigned char fontc_091[] =
    /* [ */ {0, 1, 254, 0, 254, 0, 254, 0, 254, 0, 254, 0, 254, 0, 254, 0, 254, 0, 254, 0, 254, 0, 1, 255};
unsigned char fontc_092[] = /* \ */ {255};
unsigned char fontc_093[] =
    /* ] */ {0, 1, 254, 1, 254, 1, 254, 1, 254, 1, 254, 1, 254, 1, 254, 1, 254, 1, 254, 1, 254, 0, 1, 255};
...
unsigned char fontc_097[] =
    /* a */ {254, 254, 254, 1, 1, 1, 254, 4, 254, 1, 1, 1, 1, 254, 0, 4, 254, 0, 4, 254, 1, 1, 1, 1, 255};
unsigned char fontc_098[] =
    /* b */ {0, 254, 0, 254, 0, 254, 0, 1, 1, 1, 254, 0, 4, 254, 0, 4, 254, 0, 4, 254, 0, 4, 254, 0, 1, 1, 1, 255};
unsigned char fontc_099[] = /* c */ {254, 254, 254, 1, 1, 1, 254, 0, 4, 254, 0, 254, 0, 254, 0, 4, 254, 1, 1, 1, 255};
unsigned char fontc_100[] =
    /* d */ {4, 254, 4, 254, 4, 254, 1, 1, 1, 1, 254, 0, 4, 254, 0, 4, 254, 0, 4, 254, 0, 4, 254, 1, 1, 1, 1, 255};
unsigned char fontc_101[] =
    /* e */ {254, 254, 254, 1, 1, 1, 254, 0, 4, 254, 0, 1, 1, 1, 1, 254, 0, 254, 0, 4, 254, 1, 1, 1, 255};
unsigned char fontc_102[] = /* f */ {1, 254, 0, 254, 0, 254, 0, 1, 254, 0, 254, 0, 254, 0, 254, 0, 254, 0, 255};
unsigned char fontc_103[] = /* g */ {254, 254, 254, 1, 1, 1, 1, 254, 0, 4, 254, 0, 4, 254, 0, 4, 254, 0, 4, 254, 1, 1,
    1, 1, 254, 4, 254, 0, 1, 1, 1, 255};
unsigned char fontc_104[] =
    /* h */ {0, 254, 0, 254, 0, 254, 0, 2, 1, 254, 0, 1, 3, 254, 0, 4, 254, 0, 4, 254, 0, 4, 254, 0, 4, 255};
...
unsigned char fontc_107[] =
    /* k */ {0, 254, 0, 254, 0, 254, 0, 3, 254, 0, 2, 254, 0, 1, 254, 0, 2, 254, 0, 3, 254, 0, 4, 255};
unsigned char fontc_108[] = /* l */ {0, 254, 0, 254, 0, 254, 0, 254, 0, 254, 0, 254, 0, 254, 0, 254, 0, 255};
unsigned char fontc_109[] =
    /* m */ {254, 254, 254, 0, 1, 1, 2, 1, 254, 0, 3, 3, 254, 0, 3, 3, 254, 0, 3, 3, 254, 0, 3, 3, 254, 0, 3, 3, 255};
unsigned char fontc_110[] =
    /* n */ {254, 254, 254, 0, 2, 1, 254, 0, 1, 3, 254, 0, 4, 254, 0, 4, 254, 0, 4, 254, 0, 4, 255};
unsigned char fontc_111[] =
    /* o */ {254, 254, 254, 1, 1, 1, 254, 0, 4, 254, 0, 4, 254, 0, 4, 254, 0, 4, 254, 1, 1, 1, 255};
unsigned char fontc_112[] = /* p */ {
    254, 254, 254, 0, 1, 1, 1, 254, 0, 4, 254, 0, 4, 254, 0, 4, 254, 0, 4, 254, 0, 1, 1, 1, 254, 0, 254, 0, 255};
unsigned char fontc_113[] = /* q */ {
    254, 254, 254, 1, 1, 1, 1, 254, 0, 4, 254, 0, 4, 254, 0, 4, 254, 0, 4, 254, 1, 1, 1, 1, 254, 4, 254, 4, 255};
...
unsigned char fontc_117[] =
    /* u */ {254, 254, 254, 0, 4, 254, 0, 4, 254, 0, 4, 254, 0, 4, 254, 0, 3, 1, 254, 1, 1, 2, 255};
unsigned char fontc_118[] = /* v */ {254, 254, 254, 0, 4, 254, 0, 4, 254, 1, 2, 254, 1, 2, 254, 2, 254, 2, 255};
unsigned char fontc_119[] =
    /* w */ {254, 254, 254, 0, 3, 3, 254, 0, 3, 3, 254, 0, 2, 2, 2, 254, 0, 2, 2, 2, 254, 1, 4, 254, 1, 4, 255};
unsigned char fontc_120[] = /* x */ {254, 254, 254, 0, 3, 254, 0, 3, 254, 1, 1, 254, 1, 1, 254, 0, 3, 254, 0, 3, 255};
unsigned char fontc_121[] =
    /* y */ {254, 254, 254, 0, 3, 254, 0, 3, 254, 0, 3, 254, 0, 3, 254, 1, 1, 254, 1, 254, 1, 254, 1, 255};

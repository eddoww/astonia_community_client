...
#define UI_BG_RAISED     IRGB(9, 8, 7)
#define UI_BG_SUNKEN     IRGB(4, 4, 4)
#define UI_BG_ROW_HOVER  IRGB(14, 13, 11)
#define UI_BG_ROW_ACTIVE IRGB(12, 11, 9)
#define UI_BG_INACTIVE   IRGB(5, 5, 4)
#define UI_BORDER        IRGB(18, 16, 12)
#define UI_BORDER_STRONG IRGB(24, 22, 18)
